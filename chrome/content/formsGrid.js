    ...
    tableTag:
        ...
        TABLE({"class": "netTable", cellpadding: 0, cellspacing: 0, hiddenCols: "", "role": "treegrid"},
            TBODY({"class": "netTableBody", "role" : "presentation"},
                TR({"class": "gridHeaderRow gridRow focusRow outerFocusRow", id: "formsTableHeader",
					onclick: "$AINSPECTOR.grid.onClickHeader", "role": "row", tabindex: "0",
					onkeypress: "$AINSPECTOR.grid.onKeyRow"},

                    TD({id: "formsOrderCol", "class": "gridHeaderCell gridCell a11yFocus",
    ...
    rowTag: //added background color based on rule results
        FOR("object", "$forms",
            TR({"class": "$object.severityClass gridRow a11yFocus", tabindex: "-1", //gridRow
                ...
                TD({"class": "formsOrderCol gridCol gridCell a11yFocus", "role": "gridcell",
					onkeypress: "$AINSPECTOR.grid.onKeyCell", tabindex: "-1"},
                        DIV({"class": "gridLabel"}, "$object.order")
                    ),
                TD({"class": "formsIDCol gridCol gridCell a11yFocus", "role": "gridcell",
					onkeypress: "$AINSPECTOR.grid.onKeyCell", tabindex: "-1"},
                        DIV({"class": "gridLabel"}, "$object.id")
                    ),
                TD({"class": "formsTabOrderCol gridCol gridCell a11yFocus", "role": "gridcell",
					onkeypress: "$AINSPECTOR.grid.onKeyCell", tabindex: "-1"},
                        DIV({"class": "gridLabel"}, "$object.taborder")
                    ),
                TD({"class": "formsLegendCol gridCol gridCell a11yFocus", "role": "gridcell",
					onkeypress: "$AINSPECTOR.grid.onKeyCell", tabindex: "-1"},
                        DIV({"class": "gridLabel"}, "$object.legend")
                    ),
                TD({"class": "formsLabelCol gridCol gridCell a11yFocus", "role": "gridcell",
					onkeypress: "$AINSPECTOR.grid.onKeyCell", tabindex: "-1"},
                ...
                TD({"class": "formsValueCol gridCol gridCell a11yFocus", "role": "gridcell",
					onkeypress: "$AINSPECTOR.grid.onKeyCell", tabindex: "-1"},
                         DIV({"class": "gridLabel"}, "$object.value")
                    ),
                TD({"class": "formsSourceCol gridCol gridCell a11yFocus", "role": "gridcell",
					onkeypress: "$AINSPECTOR.grid.onKeyCell", tabindex: "-1"},
                        DIV({"class": "gridLabel"}, "$object.source")
                    ),
                TD({"class": "formsIssuesCol gridCol gridCell a11yFocus", "role": "gridcell",
					onkeypress: "$AINSPECTOR.grid.onKeyCell", tabindex: "-1"},
