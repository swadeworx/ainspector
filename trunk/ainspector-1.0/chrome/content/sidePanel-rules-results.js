...
FBL.ns(function() { with (FBL) {
  ...
  var side_panel_name = AINSPECTOR_FB.ainspectorUtil.$AI_STR("ainspector.sidepanel.rules_results.name");
  var side_panel_title = AINSPECTOR_FB.ainspectorUtil.$AI_STR("ainspector.sidepanel.rules_results.title");
  
  /**
   * @function rulesResultsSidePanel displaying Rule results for the current selected 
   * row in the Navigation button,
   */
  function rulesResultsSidePanel() {}
  
  rulesResultsSidePanel.prototype = extend(Firebug.Panel, {
