...
var _contextMap = {};
		...
		this.OpenAjax.a11y = {
			 ...
			 * keyed by the 'requirementNumber' property of each requirement object in the ruleset. Each entry must contain
			 * the property 'label' (a label for the requirementNumber) and may contain the optional properties 'level'
			 * and 'description'.
