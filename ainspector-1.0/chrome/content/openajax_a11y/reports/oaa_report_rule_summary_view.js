    <script type="text/javascript">
      ...
      /**
       * @function initSummaryItemsArray
       *
       * @desc Creates an array of summary result items that can be sorted and rendered as HTML
       */
       OAA_REPORT.initSummaryItemsArray = function() {
         ...
         OAA_SUMMARY_REPORT.result_items = [];
         position = 0;
       ...
       */
       ...
       OAA_REPORT.onLoad = function() {
         ...
         OAA_REPORT.initSummaryItemsArray();
