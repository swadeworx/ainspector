...
//    adds or removes the side panels from the extension depending on the panel we are in 
    ...
    panel.table = AINSPECTOR_FB.allRules.allRulesTemplate.header.replace({elements: rule_result_items, view: "All Rules"}, toolbar, AINSPECTOR_FB.allRules.allRulesTemplate);
...
//    else Firebug.chrome.getSelectedSidePanel().updateSelection(rule_result_items[0]);
  ...
  AINSPECTOR_FB.allRules.allRulesTemplate = domplate({
    header :
