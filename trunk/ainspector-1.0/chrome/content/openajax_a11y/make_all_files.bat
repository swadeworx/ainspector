del openajax_a11y_all.js
copy openajax_a11y_constants.js+^
wai_aria\aria.js+^
...
scripts\rules.js+^
scripts\rule_results.js+^
scripts\filtered_cache_item_results.js+^
scripts\filtered_rule_group_results.js+^
scripts\cache_nls.js+^
scripts\wcag20_nls.js+^
scripts\wcag20_ruleset.js+^
scripts\progress_log.js+^
openajax_a11y.js+^
reports\reports_init.js+^
nls\cache_nls_en-us.js+^
nls\rules_nls_en-us.js+^
nls\wcag20_nls_en-us.js+^
rules\rules_color_contrast.js+^
rules\rules_controls.js+^
rules\rules_images.js+^
rules\rules_headings_landmarks.js+^
rulesets\wcag20_aria_transitional_ruleset.js+^
rulesets\wcag20_aria_strict_ruleset.js ^
