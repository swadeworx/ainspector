    <script type="text/javascript">
       ...
       */
       OAA_REPORT.addNodeResultsDetails = function() {
         ...
         var result_items     = OAA_REPORT.result_data.results;
         var result_items_len = result_items.length;
         ...
         for (var i = 0; i < result_items_len; i++) {
            ...
            for (var j = 0; j < node_results.length; j++) {
               ...
               str += ",\"" + result_item.cache_item; 
               str += "\",\"" + node_result.nls_rule_id;
               str += "\",\"" + node_result.nls_rule_type;
               str += "\",\"" + node_result.result_label;
               str += "\",\"" + node_result.message;
               str += "\"\n";
               
               var node_text = document.createTextNode(str);
               
               node_pre.appendChild(node_text);            
            }
         }   
