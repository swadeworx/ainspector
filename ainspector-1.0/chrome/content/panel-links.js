...
with (FBL) {
  ...
  AINSPECTOR_FB.links = {
	...
	viewPanel : function(context, panel_name, cache_object) {
	  ...
	  AINSPECTOR_FB.links.linksToolbar.toolbar.replace({toolbar_buttons : toolbar_buttons, preferences: AINSPECTOR_FB.preferences}, toolbar, AINSPECTOR_FB.links.linksToolbar);
