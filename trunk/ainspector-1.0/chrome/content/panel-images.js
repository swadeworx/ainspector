with (FBL) {
  ...
  var imageObject = {  
	 ...
	 * @returns
	 */
	 imagePanelView : function(images_toolbar_buttons, toolbar, panelView, images_cache) {
	        
	  var image_elements = images_cache.image_elements;
      FBTrace.sysout("image ELements: ", image_elements);
	  imagepanelPlate.toolbar.replace({images_toolbar_buttons : images_toolbar_buttons}, toolbar, imagepanelPlate);
